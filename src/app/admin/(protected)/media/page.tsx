...
export default async function MediaPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="space-y-5 w-full max-w-5xl">
      {/* Header — title + count left, Add button right on one row */}
      <div>
          ...
          {items.map((item) => (
            ...
            >
              ...
              >
                {item.type === "VIDEO" ? (
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <span className="text-xs" style={{ color: "rgba(242,239,233,0.35)" }}>Video</span>
                  </div>
                ) : (
                ...
                {item.isFeatured && (
                  <span
                    ...
                    style={{ background: "rgba(214,178,94,0.2)", color: "#d6b25e", border: "1px solid rgba(214,178,94,0.3)" }}
                  >
                    Featured
                  </span>
                )}
              ...
              <div className="p-4 space-y-3">
                <div>
                  <p className="text-sm font-semibold leading-tight" style={{ color: "#f2efe9" }}>{item.title}</p>
                ...
                {/* Toggle + action buttons — single row grid */}
                ...
                >
                  <Link
                    ...
                    className="flex items-center justify-center text-xs px-2 py-3 rounded-lg font-semibold"
                  ...
                  <a
                    ...
                    className="flex items-center justify-center text-xs px-2 py-3 rounded-lg"
                    style={{ background: "rgba(255,255,255,0.04)", color: "rgba(242,239,233,0.45)", border: "1px solid rgba(255,255,255,0.07)" }}
                  >
                    View ↗
                  </a>
